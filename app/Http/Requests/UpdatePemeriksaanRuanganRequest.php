...
class UpdatePemeriksaanRuanganRequest extends FormRequest
{
    /**
    ...
    {
        $pemeriksaanId = $this->route('pemeriksaan_ruangan')->id;
        ...
        return [
            ...
            'kondisi' => ['sometimes', 'required', 'string', 'in:BAIK,BUTUH_PERBAIKAN,RUSAK'],
        ];
    }
