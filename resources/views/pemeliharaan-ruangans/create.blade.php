<x-layouts.app :title="__('Jadwalkan Pemeliharaan Ruangan')">
    <div class="space-y-6">
        <!-- Header -->
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Jadwalkan Pemeliharaan Ruangan</h1>
                <p class="text-gray-600 mt-1">Buat jadwal pemeliharaan rutin untuk ruangan laboratorium</p>
            </div>
        ...
        <div class="bg-white rounded-lg shadow">
            <form method="POST" action="{{ route('pemeliharaan.store') }}" class="space-y-6 p-6">
                @csrf
                @method('POST')
                ...
                <div>
                    <div>
                        ...
                        <input type="text" id="judul" name="judul" value="{{ old('judul') }}" required
                               placeholder="Contoh: Pemeliharaan AC Komputer"
                ...
                <div>
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="4" required
                              placeholder="Jelaskan secara detail jenis pemeliharaan yang akan dilakukan..."
                ...
                <div class="flex items-center justify-end space-x-4 pt-6 border-t">
                    <a href="{{ route('pemeliharaan.index') }}" class="px-4 py-2 text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg font-medium">
                        Batal
                    </a>
                    <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded-lg font-medium">
                        <i class="fas fa-save mr-2"></i>Simpan Pemeliharaan
                    </button>
                </div>
            </form>
        </div>
